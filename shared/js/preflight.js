...
export default function preflight(settings) {
  ...
  settings.app.isApp = (window.location.origin === "file://" || window.location.origin === null || window.location.origin === "https://mobile.guardianapis.com") ? true : false ;

  settings.app.isIos = ios()

  settings.app.isAndroid = ( /(android)/i.test(navigator.userAgent) ) ? true : false ;

  settings.app.isiPhone = ( /(iPhone)/i.test(navigator.platform) ) ? true : false ;

  settings.app.isiPad = navigator.userAgent.match(/iPad/i) != null;

  settings.localstore = localStorage()
